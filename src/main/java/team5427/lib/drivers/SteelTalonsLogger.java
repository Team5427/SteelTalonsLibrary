...
public class SteelTalonsLogger {
  ...
  public static void post3dPose(Pose3d... poses) {
    StructArrayPublisher<Pose3d> arrayPublisher =
        NetworkTableInstance.getDefault()
            .getStructArrayTopic("Pose Array", Pose3d.struct)
            .publish();
  ...
  public static void post2dPose(Pose2d... poses) {
    StructArrayPublisher<Pose2d> arrayPublisher =
        NetworkTableInstance.getDefault()
            .getStructArrayTopic("Pose Array", Pose2d.struct)
            .publish();
    arrayPublisher.set(poses);
  }

  public static void logPoint(Translation2d... points) {
    StructArrayPublisher<Translation2d> publisher =
        NetworkTableInstance.getDefault()
            .getStructArrayTopic("MyTranslations", Translation2d.struct)
            .publish();
