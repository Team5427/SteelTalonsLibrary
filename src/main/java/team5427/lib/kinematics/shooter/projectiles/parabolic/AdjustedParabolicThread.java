...
public class AdjustedParabolicThread  extends Thread {
    ...
    @Getter
    private AdjustedParabolic parabolic = null ;

    @Getter
    @Setter
    private Tuple3Plus<Rotation2d, LinearVelocity, LinearVelocity> outputState = new Tuple3Plus<Rotation2d,LinearVelocity,LinearVelocity>(Rotation2d.kZero, MetersPerSecond.of(-1), MetersPerSecond.of(-1)    );

    @Getter
    @Setter
    private boolean shouldCompute = false;
